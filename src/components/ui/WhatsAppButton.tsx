...
export function WhatsAppButton({
  ...
  const href = buildWhatsAppUrl(siteConfig.whatsapp, message);
  ...
  const baseClass =
    variant === "primary"
      ...
      : variant === "secondary"
        ...
        : "inline-flex items-center gap-1.5 text-sm font-medium text-green-700 hover:text-green-800 hover:underline";
